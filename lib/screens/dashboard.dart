  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border(top: BorderSide(color: AppColors.grey_6)),
      ),
      padding: EdgeInsets.only(
        left: AppDimensions.paddingHorizontal16,
        right: AppDimensions.paddingHorizontal16,
        top: 7,
        bottom: 8,
      ),
      child: Container(
        ...
        child: Row(
          ...
          children: [
            bottomFlagButton(AppStrings.flagImageButton, alert),
            bottomSilenceButton(AppStrings.silenceAlertButton, alert),
            bottomCloseButton(AppStrings.dismissButton, alert),
          ],
        ),
      ),
    );
...
class MiddleSection extends StatelessWidget {
  ...
  Container cameraFieldContainer(String cameraName) {
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border(bottom: BorderSide(color: AppColors.grey_6, width: 1)),
      ),
      child: Padding(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            '$timeAgo${AppLocalizations.of(context)!.minutesAgo}',
            style: TextStyle(
              color: AppColors.whiteTextF,
              fontSize: 14,
              fontFamily: AppFonts.notoSans,
            ...
            child: Row(
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      border: Border.all(color: AppColors.primary9),
                      borderRadius: BorderRadius.circular(
                        AppDimensions.borderRadius4,
                      ),

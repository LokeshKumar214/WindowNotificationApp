...
/// Enhanced GraphQL Alert Service with comprehensive logging and C# compatibility
/// Based on the working implementation from the target project
/// Addresses URL format issues, connection problems, and image field mapping
class EnhancedGraphQLService extends ChangeNotifier {
  ...
  Future<void> _initializeGraphQLClient() async {
    ...
    try {
      ...
      logFileWrite('🌐 HTTP URL: $httpUrl');
      logFileWrite('🔌 WebSocket URL: $wsUrl');
  ...
  Alert _createAlertFromJson(Map<String, dynamic> json) {
    ...
    if (json['image'] != null) {
      ...
      if (imageValue is String) {
        ...
        _logger.w('⚠️ Unexpected image field type: ${imageValue.runtimeType}');

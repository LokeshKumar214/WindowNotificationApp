...
abstract class AppLocalizations {
  ...
  /// No description provided for @flagImageButton.
  ///
  /// In en, this message translates to:
  /// **'Flag Image'**
  String get flagImageButton;

  /// No description provided for @silenceAlertButton.
  ///
  /// In en, this message translates to:
  /// **'Silence Alert'**
  String get silenceAlertButton;
  ...
  /// No description provided for @kmPostLabel.
  ///
  /// In en, this message translates to:
  /// **'KM Post'**
  String get kmPostLabel;
  ...
  /// No description provided for @flaggingReason.
  ///
  /// In en, this message translates to:
  /// **'Choose a reason for flagging...'**
  String get flaggingReason;
}
